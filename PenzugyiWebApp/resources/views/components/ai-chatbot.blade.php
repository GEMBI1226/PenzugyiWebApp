    ...
    <div id="chatbot-window" class="chatbot-window hidden">
        ...
        <div class="chatbot-header">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="chatbot-title">AI Financial Advisor</h3>
        ...
        <div id="chatbot-messages" class="chatbot-messages">
            ...
            <div class="message ai-message">
                ...
                <div class="message-content">
                    <p>Hello! I'm your AI financial advisor. I can help you with budgeting, spending analysis, and financial planning based on your transaction data. How can I assist you today?</p>
                </div>
            </div>
        </div>
